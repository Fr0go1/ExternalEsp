...
#include "\CSGO Cheats DLL\external CSGO esp\external\imgui.h"
#include "\CSGO Cheats DLL\external CSGO esp\external\imgui_impl_dx11.h"
#include "\CSGO Cheats DLL\external CSGO esp\external\imgui_impl_win32.h"
